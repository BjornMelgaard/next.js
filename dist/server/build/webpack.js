...
exports.default = function () {
  var _ref = (0, _asyncToGenerator3.default)(_regenerator2.default.mark(function _callee2(dir) {
    ...
    var config, defaultEntries, mainJS, totalPages, entry, plugins, nodePathList, mainBabelOptions, externalBabelConfig, options, pagesRegex, rules, webpackConfig;
      ...
      while (1) {
        switch (_context2.prev = _context2.next) {
          case 0:
                  ...
                  while (1) {
                    switch (_context.prev = _context.next) {
                      case 0:
                        ...
                        _context.next = 3;
                        return (0, _globPromise2.default)('pages/**/*.{' + config.pagesExtensions.join(',') + '}', { cwd: dir });
            ...
            pagesRegex = new RegExp('\\.(' + config.pagesExtensions.join('|') + ')(\\?[^?]*)?$');
            rules = (dev ? [{
              test: pagesRegex,
            ...
            webpackConfig = {
              ...
              resolve: {
                extensions: config.pagesExtensions.map(function (ext) {
                  return '.' + ext;
                }),
